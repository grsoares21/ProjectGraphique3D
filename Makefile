...
# Generated by qmake (2.01a) (Qt 4.8.6) on: mer. déc. 2 00:04:21 2015
# Project:  cg3D.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake -o Makefile cg3D.pro
#############################################################################
...
LINK          = g++
LFLAGS        = -m64
LIBS          = $(SUBLIBS)  -L/usr/X11R6/lib64 -L/usr/lib/x86_64-linux-gnu -lGLEW -lglut -lQGLViewer -lGL -lQtXml -lQtOpenGL -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
